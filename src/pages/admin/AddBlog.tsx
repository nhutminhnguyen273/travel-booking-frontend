...
import { CreateBlogData, BlogCategory, BlogStatus } from '../../types/blog';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!token || !user || user.role !== 'admin') {
        setError('You need to be logged in as an admin to create a blog');
        return;
      }
      ...
      <Form onSubmit={handleSubmit}>
        ...
        <ButtonGroup>
          <SubmitButton type="submit" disabled={loading}>
            <FaSave /> {loading ? 'Creating...' : 'Create Blog'}
          </SubmitButton>
        </ButtonGroup>
      </Form>
    </Wrapper>
